  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.hero}>
        ...
        <Text style={styles.slogan}>All your property management needs, in one place.</Text>
...
const styles = StyleSheet.create({
  ...
  slogan: {
    ...
    marginTop: 14, textAlign: 'center', fontStyle: 'italic', paddingHorizontal: 20,
  },
  ...
  contactLink: { alignItems: 'center', paddingVertical: 16 },
  contactLinkText: { color: 'rgba(255,255,255,0.8)', fontWeight: '700', fontSize: 14 },
  devBox: {
